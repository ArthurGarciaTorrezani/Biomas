export const postQueries = {
  ...
  UPDATE_ALL:
    ...
    SELECT_POSTS_WITH_COMENT:"SELECT Posts.post_id, Posts.titulo AS titulo_post, Posts.conteudo AS conteudo_post, Comentarios.titulo AS titulo_comentario, Comentarios.conteudo AS conteudo_comentario FROM  Posts INNER JOIN   Comentarios ON  Posts.post_id = Comentarios.post_id"
};
